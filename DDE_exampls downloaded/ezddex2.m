function ezddex2
%DDEX2  Example 2 for DDE23 solved with different syntax using EZDDE23.
...
%       sol = ezdde23(@ddex2de,tau,history,[0, 600]);
%       sol = ezdde23(@ddex2de,tau,sol,[600, 1000]);
%   The solution structure SOL on [0, 600] serves as history for restarting
%   the integration at t = 600. In the second call, EZDDE23 extends SOL so that
...
sol = ezdde23(@DDEs,tau,history,[0, 1000],options);
